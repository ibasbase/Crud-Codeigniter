		...
		<div id="container">
			...
			<div id="content">
				...
				<h1 align="center" style="font-family: monospace;">LIST PAF DISTRO SUPPLIER </h1>
					<form method="POST" action="<?php echo base_url(). "index.php/controller_supplier/do_add"; ?>">
						<tr>
							<td>ID SUPPLIER</td>
							<td>
								<input type="text" name="id_supplier" size="30" readonly="readonly">
							</td>
						</tr>
						...
						<tr>
							<td>NAMA SUPPLIER</td>
							<td>
								<input type="text" name="nama_supplier" size="30">
							</td>
						</tr>
						...
						<tr>
							<td>NO TELP</td>
							<td>
								<input type="text" name="no_telp" size="30">
							</td>
						</tr>
						...
						<tr>
							<td>ALAMAT</td>
							<td>
								<textarea cols="30" rows="3" name="alamat"></textarea>
							</td>
						</tr>
